...
internal static class HarnessCoveringStyleValidator
{
    ...
    public static void Validate(JsonElement style)
    {
        ...
        if (style.TryGetProperty("texture", out var texture) && (texture.ValueKind != JsonValueKind.String || texture.GetString() is not ("auto" or "none" or "Rubber002" or "Fabric061" or "Metal049A"))) throw Invalid();
