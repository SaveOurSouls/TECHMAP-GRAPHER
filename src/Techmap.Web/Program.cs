...
builder.Services.AddSingleton(services => new HarnessDesignRecoveryJournal(dataRoot,
    services.GetRequiredService<IHarnessDesignDocumentStore>()));
...
app.MapHarnessDesignRecoveryEndpoints();
