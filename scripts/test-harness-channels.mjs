...
try {
 ...
 const combined={...measuredAutomatic,connectors:[...measuredAutomatic.connectors,...e4Base.connectors],wires:[...measuredAutomatic.wires,...e4Base.wires],junctions:[...measuredAutomatic.junctions,...e4Base.junctions]};
 ...
 assert.deepEqual(savedRemoved.content.junctions,e4Base.junctions);
